      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-100 shadow-sm space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-100 pb-3">
          <div>
            ...
            <p className="text-xs text-gray-500">Search by job title, skill, or location</p>
          </div>
          {hasActiveFilters && (
            <button
              onClick={resetFilters}
              className="text-xs font-bold text-red-600 hover:text-red-800 bg-red-50 hover:bg-red-100 px-3 py-1.5 rounded-xl transition flex items-center gap-1 cursor-pointer self-start sm:self-auto"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
          ...
          <div className="md:col-span-6 relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-11 pr-9 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs sm:text-sm font-semibold text-[#1e293b] focus:outline-none focus:border-[#2B2A8C] focus:bg-white transition"
            />
            {searchTerm && (
              <button
          ...
          <div className="md:col-span-6 relative flex items-center">
            <MapPin className="w-5 h-5 text-[#2B2A8C] absolute left-3.5 pointer-events-none" />
            <input
              type="text"
